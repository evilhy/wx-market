  ...
  <div class="result-outline-wrap">
    ...
    <template v-if="markList.length">
      ...
      <template v-if="term === 1">
        <!-- 达到最高档 -->
        <div class="tip"
             v-if="currentIndex === markList.length - 1">恭喜，已有<span class="stress">{{productInfo.intentNum}}</span>位同事完成预约！<br />收益已达最高档位<span class="stress">{{markList[currentIndex].levelRate}}%</span></div>
        <!-- 未达到最高档 -->
        <div class="tip"
             v-else>
          <!-- 达成当前档位 -->
