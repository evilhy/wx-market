<template>
  <div class="invoice-rule">
    <img class="wacth-out" :class="[invoiceImg ? 'move-in' : 'move-out']" src="../assets/img/invoice-pop.png" alt=""
      v-show="visible==false" @click="show">
    <van-popup v-model="visible" :overlay="false" class="pop">
      <div class="pop-bg">
