<template>
  <div class="msg-box">
    <div class="msg-list-wrap" ref="wrapper">
      ...
      <div class="no-msg" v-else>有任何疑问可在此留言，我会尽快为您提供服务</div>
    </div>
...
export default {
  ...
  methods: {
    ...
    scrollTo(eleIndex) {
      this.$nextTick(() => {
        const scrollTop = typeOf(eleIndex) === 'number' ? document.querySelector(`.item-${this.msgList[eleIndex].chat_msg_id}`).offsetTop : this.scrollWrapper.scrollHeight
